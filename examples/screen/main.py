...
def main(
    model_id_or_path: str = "Lykon/absolute-reality-1.81", #"stabilityai/sd-turbo",
    lora_dict: Optional[Dict[str, float]] = None,
    prompt: str = "beautiful landscape, mountains, grass, trees, oil painting, highly realistic, high quality, professional, 4k, hdr",
    negative_prompt: str = "houses, human, building, low quality, bad quality, blurry, low resolution, amatuer",
    ...
    similar_image_filter_max_skip_frame: float = 1, # 10
) -> None:
    """
